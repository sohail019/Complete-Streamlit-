...
#* DDK is high level UI frameworkd that is purpose-built for Dash. It is a collection of components that are designed to work together to make it easier to build Dash apps.

from dash import Dash, html, dash_table, dcc, callback, Output, Input
import pandas as pd
import plotly.express as px
import dash_design_kit as ddk #? note that we won't be able to run this example without a Dash Enterprise license
